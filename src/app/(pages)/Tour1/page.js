...
import WageDropdown from "../../../components/WageDropdown";
  ...
  const handleDetails = async () => {
    try {
      const response = await fetch(
        ...
        // "http://uat.cept.gov.in/payroll2/payroll/gpf/v1/getEmp/10063546",
        // "https://uat.cept.gov.in/payroll2/payroll/gpf/v1/getEmp/8308331455"
        "https://localhost:6298/payroll/gpf/v1/Claim/Reimb"
      );
      console.log("View Claim", response);
  ...
  return (
    <div>
      ...
      <div className="border border-gray-500 p-4 m-1">
        <div className="box-shadow m-1 flex items-top justify-start rounded-lg">
          <div className=" w-full">
            <h1 className="flex align-left justify-start pl-1 font-bold text-sx bg-red-200 rounded-t-lg">
              Employee Details :
            </h1>
            {/* {res?.map((e, i) => {
              return ( */}
        ...
        <div>
          <div className="box-shadow m-1 h-40 flex items-top justify-start rounded-lg mt-3">
            <div className=" w-full mb-5">
              {/* {res?.map((e, i) => {
              return ( */}
              <div className="flex flex-row">
                <div className=" w-1/4 ml-1 mt-1 ">
                ...
                <button
                  className=" ml-20 mt-10 h-12 btn btn_primary btn_md my-3"
        ...
        {showInputs && (
          <div className="box-shadow flex-col m-1 h-40 flex items-top justify-start rounded-lg mt-3">
            <h1 className="flex align-left justify-start pl-1 font-bold text-sx bg-red-200 rounded-t-lg">
              Details :
            </h1>
            <div className="flex flex-col justify-start ">
              <div className="flex justify-evenly">
                Min Amount:
                <span> Sub wage Type</span>
              </div>
              <div className="flex justify-evenly">
                Max Amount: <span> Sub Wage Type Desc.</span>
              </div>
              ...
              {/* <div>Sub Wage Type</div>
              <div>Sub Wage Type Desc.</div> */}
            </div>
          </div>
        )}
        ...
        <div className="border border-gray-500  m-1">
          <div className="flex items-top justify-start align-top">
            <div className=" w-full bg-black-200">
              {/* <h1 className="flex align-t   p justify-start pl-1 font-bold text-sx bg-red-200 min-w-screen items-center">
